...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-complete) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce true if los includes input string s
...
;; takes in a list of numbers and returns any numbers mathing fn criteria
