...
public class GymChainInfo {
    ...
    public static final String FROGTOWN_GYM_NAME = "Frogtown";
    public static final String KATIE_MEMBER_NAME = "Katie";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(KATIE_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym g4 = new Gym(FROGTOWN_GYM_NAME);
        initializeGym0(g4);
        chain.addGym(g4);
    }
