...
public class HairSalon {
    ...
    SpecialistSuggestor specialistSuggestor = new SpecialistSuggestor();
...
//        addTreatmentSpecialist(condition, "Bob");
    ...
    public boolean makeNewBooking(Customer c, int bookingTime, Treatment treatment){
        if (checkBookingTimeValid(bookingTime, treatment)) return false;
    ...
    private boolean checkBookingTimeValid(int bookingTime, Treatment treatment) {
