...
public class InfoManager {
    ...
    private static final String FROGTOWN_COMMAND = "frogtown";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + FROGTOWN_COMMAND + "' for Fitlife " + FROGTOWN_GYM_NAME);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case FROGTOWN_COMMAND:
                    printGymInfo(chain.lookupGymByName(FROGTOWN_GYM_NAME));
                    break;
