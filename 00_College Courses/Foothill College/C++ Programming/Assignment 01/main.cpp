...
Syllabus detail #1: The text (Absolute C++ by Walter Savitch) is recommended, but not required.

Syllabus detail #2: Comfort with Algebra and English comprehension may prove helpful.

Specific lab detail #1: No points will be granted for a program that doesn't compile and run.

Specific lab detail #2: Late assignments are penalized 2 points per day.

Specific lab detail #3: Output should provide informative and clarifying information.
