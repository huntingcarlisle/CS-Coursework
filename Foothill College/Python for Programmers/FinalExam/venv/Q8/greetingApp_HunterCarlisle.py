...
class MyFrame(tkinter.Frame):
    ...
    def sayHi(self):
        """ says hello to the user by taking the text from the nameEntry field and putting it into the greeting field """
        self.greeting["text"] = "Hello " + self.nameEntry.get()

    def sayBye(self):
        """ says goodbye to the user by taking the text from the nameEntry field and putting it into the greeting field """
